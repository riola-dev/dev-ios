...
enum StringLiteral {
    ...
    static let systemPrompt = """
                         ...
                         평가는 두가지 기준이 있습니다. 우선 제가 질문에 맞는 답을 했는지 확인을 해야합니다. 그리고 답변의 구체적인 정도에 따라 1~10 사이의 점수로 평가해주십시오. 만약 답변이 틀렸거나 질문과 상관없는 내용인 경우, 혹은 모르겠다고 답한 경우 0점을 주십시오.
                         답변은 "점수 : (~/10), 해당 점수를 준 이유 : , 10점짜리 답변: "와 같은 양식으로 해주십시오.
                         """
